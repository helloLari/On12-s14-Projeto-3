...
- Colocar em prática os conhecimentos sobre CRUD em API;

- Aperfeioar o entendimento sobre a dependência Mongoose;

- Criação de database e collections a partir dos inserts no Postman;

- Criar "ligação" entre collections, utilizando um documento para popular outro documento de uma collection distinta;
